...
function validateForm() {
	 	if(studentIdValidate()==true){
			if(userNameValidate()==true){
				if(studentNameValidate()==true){
					if(cityStateValidate()==true){
						if(telephoneValidate()==true){
							if(emailValidate()==true){
									if(checkBoxesValidate()==true){
										if(radioButtonValidate()==true){
										  // if(dataNumberValidate()==true){
